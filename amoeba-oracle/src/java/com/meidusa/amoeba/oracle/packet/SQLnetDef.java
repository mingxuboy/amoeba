...
public interface SQLnetDef {
    ...
    public static final int     NS_PACKT_TYPE_CONNECT                 = 1;
    public static final int     NS_PACKT_TYPE_ACCEPT                  = 2;
    public static final int     NS_PACKT_TYPE_ACK                     = 3;
    public static final int     NS_PACKT_TYPE_REFUTE                  = 4;
    public static final int     NS_PACKT_TYPE_REDIRECT                = 5;
    public static final int     NS_PACKT_TYPE_DATA                    = 6;
    public static final int     NS_PACKT_TYPE_NULL                    = 7;
    public static final int     NS_PACKT_TYPE_ABORT                   = 9;
    public static final int     NS_PACKT_TYPE_RESEND                  = 11;
    public static final int     NS_PACKT_TYPE_MARKER                  = 12;
    public static final int     NS_PACKT_TYPE_ATTENTION               = 13;
    public static final int     NS_PACKT_TYPE_CONTROL                 = 14;
    public static final int     NS_PACKT_TYPE_HI                      = 19;
