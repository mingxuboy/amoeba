...
// Source File Name:   CharacterSetAL16UTF16.java
    ...
    implements CharacterRepConstants
{
    ...
    public String toStringWithReplacement(byte abyte0[], int i, int j)
    {
        ...
        try{
        ac = new char[j >>> 1];
        k = CharacterSet.convertAL16UTF16BytesToJavaChars(abyte0, i, ac, 0, j, true);
...
//        return "";
        ...
        throws SQLException
    {
        ...
        try{
        ac = new char[j >>> 1];
        k = CharacterSet.convertAL16UTF16BytesToJavaChars(abyte0, i, ac, 0, j, false);
        return new String(ac, 0, k);
        }catch(SQLException sqlexception){
            failUTFConversion();
            return "";
...
//        return "";
        ...
        throws SQLException
    {
        ...
        } else
        {
            ...
            abyte1 = stringToAL16UTF16Bytes(s);
        }
        return abyte1;
    }
