 ...
 */
public class T4C8TTIdtyDataPacket extends T4CTTIMsgPacket {
    ...
    protected void init(AbstractPacketBuffer buffer) {
        ...
        short ctcapLength = meg.unmarshalUB1();
        CTcap = meg.unmarshalNBytes(ctcapLength);
        short rtcapLength = meg.unmarshalUB1();
        RTcap = meg.unmarshalNBytes(rtcapLength);
        typeReps10 = meg.unmarshalNBytes(buffer.getPacketLength()-buffer.getPosition()-1);
    }
