 ...
 */
package com.meidusa.amoeba.mongodb.server;
 ...
 * 
 */
public class MongodbProxyServer {
	private static Logger log = Logger.getLogger(MongodbProxyServer.class);
	...
	public static void main(String[] args) throws IOException {
		...
		Logger logger = Logger.getLogger(MongodbProxyServer.class);
