...
public class BSONDecoder {
    ...
    public static void main(String[] args){
    	...
    	object.put("aa", "asdfa阿桑的发生的发");
    	object.put("1", "asdfa阿桑的发生的发");
    	object.put("2", "asdfa阿桑的发生的发");
    	object.put("3", "asdfa阿桑的发生的发");
    	object.put("4", "asdfa阿桑的发生的发");
    	object.put("5", "asdfa阿桑的发生的发");
    	object.put("6", "asdfa阿桑的发生的发");
