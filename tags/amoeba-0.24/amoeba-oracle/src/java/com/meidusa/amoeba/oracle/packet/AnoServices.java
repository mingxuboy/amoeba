...
/**
 * @author hexianmao
 * @version 2008-8-11 ÏÂÎç04:17:26
 */
public interface AnoServices {

    public static final int      AUTHENTICATION             = 1;
    public static final int      MAXSERVICE                 = 4;
    public static final String[] ENC_CLASSNAME_EX           = { "", "RC4_40", "DES56C", "DES40C", "", "", "RC4_256", "", "RC4_56", "", "RC4_128", "3DES112", "3DES168" };
    ...
    public static final String[] ENC_CLASSNAME              = { "", "RC4_40", "DES56C", "DES40C", "", "", "RC4_256", "DES56R", "RC4_56", "DES40R", "RC4_128", "3DES112", "3DES168" };
    public static final String[] SERV_CLASSNAME             = { "NULLSERVICE", "AuthenticationService", "EncryptionService", "DataIntegrityService", "SupervisorService" };
    ...
    public static final String[] SERVICES_INORDER           = { "Supervisor", "Authentication", "Encryption", "DataIntegrity" };
    ...
    public static final String[] SERV_INORDER_CLASSNAME     = { "SupervisorService", "AuthenticationService", "EncryptionService", "DataIntegrityService" };
