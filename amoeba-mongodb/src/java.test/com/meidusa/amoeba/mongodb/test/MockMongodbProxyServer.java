 ...
 * 
 */
public class MockMongodbProxyServer {
	private static Logger log = Logger.getLogger(MockMongodbProxyServer.class);
	...
	public static void main(String[] args) throws IOException {
		...
		Logger logger = Logger.getLogger(MockMongodbProxyServer.class);
		ProxyRuntimeContext context = new MongodbProxyRuntimeContext();
		...
		MockClientConnectionFactory factory = new MockClientConnectionFactory();
